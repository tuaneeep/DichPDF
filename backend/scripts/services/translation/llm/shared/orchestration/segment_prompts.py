...
def segment_translation_system_prompt(domain_guidance: str = "") -> str:
    prompt = (
        ...
        "Use concise publication-style Vietnamese suitable for scientific writing.\n"
        "Keep abbreviations, symbols, and standard model names in their normal technical form.\n"
        "If a segment is only a connector or incomplete phrase, keep it equally short and incomplete in Vietnamese.\n"
...
def segment_translation_tagged_prompt(domain_guidance: str = "") -> str:
    prompt = (
        ...
        "Translate each segment independently into concise publication-style Vietnamese.\n"
